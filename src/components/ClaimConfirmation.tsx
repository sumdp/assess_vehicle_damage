...
export default function ClaimConfirmation({ claimData, finalAssessment, onNewClaim }: ClaimConfirmationProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="text-center py-6">
        ...
        <h2 className="text-2xl font-semibold text-green-700">
          {approvalLevel === 'senior' ? 'Submitted for Senior Approval' : 'Estimate Approved'}
        </h2>
